...
public class HomeScienceActivity2 extends AppCompatActivity {
    ...
    public String fbpath="pdf/Art/HomeScience/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_science2);

        System.out.println("created");

        btn = findViewById(R.id.btnho6);
